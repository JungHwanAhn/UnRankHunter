...
UMiniMT26_Anim::UMiniMT26_Anim()
{
	static ConstructorHelpers::FObjectFinder<UAnimMontage>
		EnergyBall_Montage(TEXT("AnimMontage'/Game/01_Core/AJH/Enemy/Robot/Boss/Montage/Plazma/AJH_AM_MiniMT26_EnergyBall.AJH_AM_MiniMT26_EnergyBall'"));
	if (EnergyBall_Montage.Succeeded()) {
		EnergyBallMontage = EnergyBall_Montage.Object;
	}
	static ConstructorHelpers::FObjectFinder<UAnimMontage>
		Shelling_Montage(TEXT("AnimMontage'/Game/01_Core/AJH/Enemy/Robot/Boss/Montage/Shelling/AJH_AM_MiniMT26_Shelling.AJH_AM_MiniMT26_Shelling'"));
	if (Shelling_Montage.Succeeded()) {
		ShellingMontage = Shelling_Montage.Object;
	}

	static ConstructorHelpers::FObjectFinder<UAnimMontage>
		HomingRocket_Montage(TEXT("AnimMontage'/Game/01_Core/AJH/Enemy/Robot/Boss/Montage/Shelling/AJH_AM_MiniMT26_HomingRocket.AJH_AM_MiniMT26_HomingRocket'"));
	if (HomingRocket_Montage.Succeeded()) {
		HomingRocketMontage = HomingRocket_Montage.Object;
	}

	static ConstructorHelpers::FObjectFinder<UAnimMontage>
		LaserShot_Montage(TEXT("AnimMontage'/Game/01_Core/AJH/Enemy/Robot/Boss/Montage/Laser/AJH_AM_MiniMT26_LaserShot.AJH_AM_MiniMT26_LaserShot'"));
	if (LaserShot_Montage.Succeeded()) {
		LaserShotMontage = LaserShot_Montage.Object;
	}

	static ConstructorHelpers::FObjectFinder<UAnimMontage>
		GunAttack_Montage(TEXT("AnimMontage'/Game/01_Core/AJH/Enemy/Robot/Boss/Montage/AJH_AM_MiniMT26_GunAttack.AJH_AM_MiniMT26_GunAttack'"));
	if (GunAttack_Montage.Succeeded()) {
		GunAttackMontage = GunAttack_Montage.Object;
	}
