...
#include "ShieldSkeleton.generated.h"

UCLASS()
class UNRANKHUNTER_API AShieldSkeleton : public ABaseEnemy_Common
{
	GENERATED_BODY()
...
private:
	...
	class UStaticMeshComponent* RightSkeletonWeapon;

	UPROPERTY(EditDefaultsOnly, Category = "Weapon");
	class UStaticMeshComponent* LeftSkeletonWeapon;

	float shieldSkeletonHP = 100;
};
